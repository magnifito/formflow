            ...
            <CardHeader className="pb-4">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>Target: <code className="bg-muted px-1 py-0.5 rounded text-xs">{form.submitHash}</code></CardDescription>
                    </div>
                ...
                <form id="submission-form" onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4 pt-4 border-t">
                        <div className="flex items-center justify-between">
                            ...
                            <Button type="button" variant="ghost" size="sm" onClick={handleCustomFieldAdd}>
                        ...
                        {customFields.map((field, idx) => (
                            <div key={idx} className="flex items-center gap-2">
                                ...
                                />
                                <Button type="button" variant="ghost" size="icon" className="h-8 w-8 text-destructive" onClick={() => handleCustomFieldRemove(idx)}>
