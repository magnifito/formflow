...
export class InitialSchema1737227400000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "whitelisted_domain"
            ADD CONSTRAINT "FK_whitelisted_domain_organizationId"
            FOREIGN KEY ("organizationId")
            REFERENCES "organization"("id")
            ON DELETE CASCADE
            ON UPDATE NO ACTION
        ...
        await queryRunner.query(`
            ALTER TABLE "form"
            ADD CONSTRAINT "FK_form_organizationId"
            FOREIGN KEY ("organizationId")
            REFERENCES "organization"("id")
            ON DELETE SET NULL
            ON UPDATE NO ACTION
        ...
        await queryRunner.query(`
            ALTER TABLE "form_integration"
            ADD CONSTRAINT "FK_form_integration_formId"
            FOREIGN KEY ("formId")
            REFERENCES "form"("id")
            ON DELETE CASCADE
            ON UPDATE NO ACTION
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_organization_integration_organizationId"
            FOREIGN KEY ("organizationId")
            REFERENCES "organization"("id")
            ON DELETE CASCADE
            ON UPDATE NO ACTION
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_submission_formId"
            FOREIGN KEY ("formId")
            REFERENCES "form"("id")
            ON DELETE CASCADE
            ON UPDATE NO ACTION
