...
export class DashboardUserInfoComponent implements OnInit {
  ...
  fetchApiKey = async (userId: string) => {
    ...
    console.log(data);
    if (!data.apiKey) {
      fetch(fetchUrl + '/create-api-key/' + userId, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${jwtToken}`
        }
  ...
  saveOptions = () => {
    ...
    if (emailInput) {
      ...
      fetch(fetchUrl + '/update-return-email/' + this.userId, {
        method: 'post',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  async teleSwitch() {
    ...
    await fetch(fetchUrl + '/telegram/toggle/' + this.userId, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${jwtToken}`
  ...
  async discordSwitch() {
    ...
    await fetch(fetchUrl + '/discord/toggle/' + this.userId, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${jwtToken}`
  ...
  async saveDiscordWebhook() {
    ...
    if (discordInput) {
      ...
      await fetch(fetchUrl + '/discord/webhook/' + this.userId, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${jwtToken}`
  ...
  async slackSwitch() {
    ...
    await fetch(fetchUrl + '/slack/toggle/' + this.userId, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${jwtToken}`
  ...
  connectToSlack = () => {
    ...
    const url = `https://slack.com/oauth/v2/authorize?client_id=7572076162737.7563846148610&scope=incoming-webhook&user_scope=channels:read,chat:write&state=${this.userId}`;
    window.open(url);
  }
  ...
  async makeSwitch() {
    ...
    await fetch(fetchUrl + '/make/toggle/' + this.userId, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${jwtToken}`
  ...
  async saveMakeWebhook() {
    ...
    if (discordInput) {
      ...
      await fetch(fetchUrl + '/make/webhook/' + this.userId, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${jwtToken}`
  ...
  async n8nSwitch() {
    ...
    await fetch(fetchUrl + '/n8n/toggle/' + this.userId, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${jwtToken}`
  ...
  async saveN8nWebhook() {
    ...
    if (discordInput) {
      ...
      await fetch(fetchUrl + '/n8n/webhook/' + this.userId, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${jwtToken}`
  ...
  async webhookSwitch() {
    ...
    await fetch(fetchUrl + '/webhook/toggle/' + this.userId, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${jwtToken}`
  ...
  async saveWebhookWebhook() {
    ...
    if (discordInput) {
      ...
      await fetch(fetchUrl + '/webhook/webhook/' + this.userId, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${jwtToken}`
  ...
  discordDocs = () => {
    window.open("https://docs.formflow.fyi/docs/integrations/Discord");
  }

  telegramDocs = () => {
    window.open("https://docs.formflow.fyi/docs/integrations/Telegram");
  }

  n8nDocs = () => {
    window.open("https://docs.formflow.fyi/docs/integrations/n8n");
  }

  makeDocs = () => {
    window.open("https://docs.formflow.fyi/docs/integrations/make");
  }
  ...
  addDomain = () => {
    ...
    if (this.domains.length <= 50) {
      ...
      if (input) {
        ...
        if (domain) {
          fetch(fetchUrl + '/add-domain/' + this.userId, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${jwtToken}`
